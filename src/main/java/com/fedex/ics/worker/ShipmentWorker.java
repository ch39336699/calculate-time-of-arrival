package com.fedex.shipment.worker;
...
import com.fedex.shipment.jpa.ShipmentRepository;

@Component
public class ShipmentWorker {
  
  private static final Log logger = LogFactory.getLog(ShipmentWorker.class);
  @Autowired
